...
1. eCommerce example site [TheCartPress Extend](http://thecartpress.com/extend): plugins, themes and custom development
2. Shopping cart
3. Checkout
4. Product list
...
* Javascript bug
* Sample products file, from thecartpress.com/demo
...
= 1.4.8.1 =
* French translation updates, thanks to Sophie (https://www.sophie-g.net/)
