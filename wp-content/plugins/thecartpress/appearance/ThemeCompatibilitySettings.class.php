...
// since 1.5.0
$use_custom_login_ver_two					= $thecartpress->get_setting( 'use_custom_login_ver_two', false );
...
// since 1.5.0
$see_product_thumbnail						= $thecartpress->get_setting( 'see_product_thumbnail' . $suffix, true );
?>
...
<tr valign="top">
	<th scope="row">
		<label for="use_custom_login_ver_two"><?php _e( 'Use custom login ver. 2', 'tcp' ); ?></label>
	</th>
	<td>
		<input type="checkbox" id="use_custom_login_ver_two" name="use_custom_login_ver_two" <?php checked( $use_custom_login_ver_two ); ?> value="yes" />
	</td>
</tr>
...
<tr valign="top">
	<th scope="row">
	<label for="see_product_thumbnail"><?php _e( 'See product thumbnail', 'tcp' ); ?></label>
	</th>
	<td>
		<input type="checkbox" id="see_product_thumbnail" name="see_product_thumbnail" value="yes" <?php checked( $see_product_thumbnail ); ?> />
	</td>
</tr>
...
<?php
	...
	function admin_action() {
		...
		if ( isset( $_POST['delete_post_type_settings'] ) ) {
			...
			unset( $settings['see_product_thumbnail' . $suffix] );
		...
		$settings['see_product_thumbnail' . $suffix]		= isset( $_POST['see_product_thumbnail'] );
		...
		$settings['use_custom_login_ver_two']				= isset( $_POST['use_custom_login_ver_two'] );
