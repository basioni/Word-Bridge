...
<div class="inside">
	...
	<tr valign="top">
		...
		<td>
			<label><?php _e( 'Time', 'tcp' ); ?>: <input type="text" id="tcp_time" name="tcp_time" value="<?php echo date( 'Y-m-d H:i', (int)$time ); ?>" class="tcp-date-time-picker" size="20" /></label> <?php _e( 'Format YYYY-MM-DD hh:mm', 'tcp' ); ?>
		</td>
	</tr>
	</tbody>
	</table>
