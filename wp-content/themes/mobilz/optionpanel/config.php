        ...
        public function setSections() {
				...
				'fields' => array(
					...
					array(
					 ...
					 array(
						'id'       =>'google-api',
						'type'     => 'text',
						'title'    => __('Google map API', TEMPNAME),
						'subtitle' => __('Enter google API here', TEMPNAME),
						'default'  => ''
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'subtitle' => __('Upload .jpg, .png or .gif image that will be your retina logo. Make sure that your image ends with symbols @2 (example logo@2.png)', TEMPNAME)
					),
					...
					array(
						'id'       =>'desk-sl-align',
						'type'     => 'select',
						'title'    => __('Social links alignment', TEMPNAME),
						'options'  => array(
							"left"   => "Left",
							"right"  => "Right"
						),
					...
					array(
						'id'       =>'desk-ls-hover',
						'type'     => 'color',
						'title'    => __('Language select hover text colors', TEMPNAME),
					    'default'  => '#777777'
					),

					array(
						'id'       =>'desk-ls-back-hover',
						'type'     => 'color',
						'title'    => __('Language select background hover colors', TEMPNAME),
					    'default'  => '#f9f9f9'
					),
					...
					array(
						'id'      =>'desk-menu-border',
						'type'    => 'switch', 
						'title'   => __('Header top level menu border', TEMPNAME),
						"default" => 0,
					),

					array(
						'id'       =>'desk-menu-border-color',
						'type'     => 'color_rgba',
						'title'    => __('Header top level menu border color', TEMPNAME),
						'default'  => array(
					        'color' => '#eeeeee', 
					        'alpha' => '1.0'
					    )
					...
					array(
						'id'       =>'desk-submenu-border-top-color',
						'type'     => 'color',
						'title'    => __('Submenu border top color', TEMPNAME),
					),
					...
					array(
						'id'       =>'desk-megamenu-top-color',
						'type'     => 'color',
						'title'    => __('Megamenu top level color', TEMPNAME)
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'stuck-submenu-border-top-color',
						'type'     => 'color',
						'title'    => __('Submenu border top color', TEMPNAME),
					),

					array(
						'id'       =>'stuck-megamenu-top-color',
						'type'     => 'color',
						'title'    => __('Megamenu top level color', TEMPNAME)
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'fixed-submenu-border-top-color',
						'type'     => 'color',
						'title'    => __('Submenu border top color', TEMPNAME),
					),

					array(
						'id'       =>'fixed-megamenu-top-color',
						'type'     => 'color',
						'title'    => __('Megamenu top level color', TEMPNAME)
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'footer-border',
						'type'     => 'color',
						'title'    => __('Footer border color', TEMPNAME),
						'default'  => '#2a303a',
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'button-color',
						'type'     => 'color',
						'title'    => __('Button color', TEMPNAME), 
						'default'  => '#ffffff'
					),
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'       =>'slider-cc',
						'type'     => 'color_rgba',
						'title'    => __('Slider controls color', TEMPNAME), 
						'default'  => array(
					        'color' => '#000000', 
					        'alpha' => '0.3'
					    )
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						'id'      =>'shop-banner',
						'type'     => 'editor',
						'title'    => __('Shop banner area', TEMPNAME),
						'subtitle' => __('Enter some shop banner', TEMPNAME),
						'args'    => array('wpautop' => false,'media_buttons' => true)
					),
