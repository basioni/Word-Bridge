...
if (isset($images) && !empty($images)) {
	...
	foreach ( $images as $attach_id ) {
		...
		if ( $attach_id > 0 ) {
			...
			if ($link_full == "true") {
				$gal_images .= '<div class="gallery-item">'.$before_img.'<a data-lightbox-gallery="gallery1" href="'.$link[0].'"><div class="ninzio-overlay"><div class="ovhover"></div></div><img alt="'.$thumb_img->post_excerpt.'" src="'.$img[0].'" width="'.$img[1].'" height="'.$img[2].'" /></a>'.$after_img.'</div>';
			} else {
