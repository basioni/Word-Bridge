...
<?php
	...
	$nz_shop_banner = (isset($nz_ninzio['shop-banner']) && !empty($nz_ninzio['shop-banner'])) ? '<div class="shop-banner">'.do_shortcode(wp_kses_post($nz_ninzio['shop-banner'])).'</div>' : '';
