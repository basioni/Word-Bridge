...
$nz_slider_arrows       = ($nz_ninzio['slider-arrows'] && $nz_ninzio['slider-arrows'] == 1) ? "true" : "false";
					...
					<?php for ($i=1; $i <= 7; $i++) { ?>
						<?php if(!empty($values["layer_$i"][0])) { ?>
							<?php
					    		...
					    		$styles .= " .active #ninzio-layer-$post->ID-$i, .active #ninzio-layer-$post->ID-$i .layer-wrap {";
								...
								$styles .= ".ninzio-slider.first-active #ninzio-layer-$post->ID-$i, .ninzio-slider.first-active #ninzio-layer-$post->ID-$i .layer-wrap {";
									foreach ($prefixes as $prefix) {
								...
								/*======================*/
									...
									if ($nz_slider_mobile) {
										...
										$styles_320 .= " .active #ninzio-layer-$post->ID-$i, #ninzio-layer-$post->ID-$i.none, #ninzio-layer-$post->ID-$i.scalein, #ninzio-layer-$post->ID-$i.scaleout {";
											$styles_320 .='top:'.round(${"layer_posy_$i"}*0.25, 0).'px !important;';
											$styles_320 .='left:'.round(${"layer_posx_$i"}*0.25, 0).'px !important;';
										$styles_320 .= "}";

										$styles_480 .= " .active #ninzio-layer-$post->ID-$i, #ninzio-layer-$post->ID-$i.none, #ninzio-layer-$post->ID-$i.scalein, #ninzio-layer-$post->ID-$i.scaleout {";
											$styles_480 .='top:'.round(${"layer_posy_$i"}*0.38, 0).'px !important;';
											$styles_480 .='left:'.round(${"layer_posx_$i"}*0.38, 0).'px !important;';
										$styles_480 .= "}";
									...
									$styles_768 .= " .active #ninzio-layer-$post->ID-$i, #ninzio-layer-$post->ID-$i.none, #ninzio-layer-$post->ID-$i.scalein, #ninzio-layer-$post->ID-$i.scaleout {";
										$styles_768 .='top:'.round(${"layer_posy_$i"}*0.62, 0).'px !important;';
										$styles_768 .='left:'.round(${"layer_posx_$i"}*0.62, 0).'px !important;';
									$styles_768 .= "}";

									$styles_1024 .= " .active #ninzio-layer-$post->ID-$i, #ninzio-layer-$post->ID-$i.none, #ninzio-layer-$post->ID-$i.scalein, #ninzio-layer-$post->ID-$i.scaleout {";
										$styles_1024 .='top:'.round(${"layer_posy_$i"}*0.82, 0).'px !important;';
										$styles_1024 .='left:'.round(${"layer_posx_$i"}*0.82, 0).'px !important;';
									$styles_1024 .= "}";

									$styles_1025 .= " .active #ninzio-layer-$post->ID-$i, #ninzio-layer-$post->ID-$i.none, #ninzio-layer-$post->ID-$i.scalein, #ninzio-layer-$post->ID-$i.scaleout, #ninzio-layer-$post->ID-$i.ghostleft, #ninzio-layer-$post->ID-$i.ghostright, #ninzio-layer-$post->ID-$i.ghosttop, #ninzio-layer-$post->ID-$i.ghostbottom {";
										$styles_1025 .='top:'.${"layer_posy_$i"}.'px !important;';
										$styles_1025 .='left:'.${"layer_posx_$i"}.'px !important;';
									$styles_1025 .= "}";
							...
							<div id="ninzio-layer-<?php echo $post->ID."-".$i; ?>" class="ninzio-layer <?php echo ${"layer_direction_$i"}; ?>" data-direction="<?php echo ${"layer_direction_$i"}; ?>" data-posx="<?php echo ${"layer_posx_$i"}; ?>" data-posy="<?php echo ${"layer_posy_$i"}; ?>">
								<div class="layer-wrap"><?php echo apply_filters('the_content', $values["layer_$i"][0] ); ?></div>
							</div>
						<?php } ?>
					<?php } ?>
