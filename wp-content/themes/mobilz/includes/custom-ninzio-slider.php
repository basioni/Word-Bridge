	    						...
	    						<div class="ninzio-accordion-content">
									...
									<label>
										...
										<select id="layer-direction-<?php echo($i); ?>" class="ninzio-slider-animation direction" name="layer_direction_<?php echo($i); ?>">
											...
											<option value="left" <?php selected( ${"layer_direction_$i"}, 'left' ); ?>><?php echo __("Appear from Left", TEMPNAME); ?></option>
											<option value="right" <?php selected( ${"layer_direction_$i"}, 'right' ); ?>><?php echo __("Appear from Right", TEMPNAME); ?></option>
											<option value="top" <?php selected( ${"layer_direction_$i"}, 'top' ); ?>><?php echo __("Appear from Top", TEMPNAME); ?></option>
											<option value="bottom" <?php selected( ${"layer_direction_$i"}, 'bottom' ); ?>><?php echo __("Appear from Bottom", TEMPNAME); ?></option>
											<option value="scalein" <?php selected( ${"layer_direction_$i"}, 'scalein' ); ?>><?php echo __("Scale in", TEMPNAME); ?></option>
											<option value="scaleout" <?php selected( ${"layer_direction_$i"}, 'scaleout' ); ?>><?php echo __("Scale out", TEMPNAME); ?></option>
											<option value="ghostleft" <?php selected( ${"layer_direction_$i"}, 'ghostleft' ); ?>><?php echo __("Ghost from left", TEMPNAME); ?></option>
											<option value="ghostright" <?php selected( ${"layer_direction_$i"}, 'ghostright' ); ?>><?php echo __("Ghost from right", TEMPNAME); ?></option>
											<option value="ghostbottom" <?php selected( ${"layer_direction_$i"}, 'ghostbottom' ); ?>><?php echo __("Ghost from bottom", TEMPNAME); ?></option>
											<option value="ghosttop" <?php selected( ${"layer_direction_$i"}, 'ghosttop' ); ?>><?php echo __("Ghost from top", TEMPNAME); ?></option>
										</select>
									</label>
									<label class="ninzio-validation">
