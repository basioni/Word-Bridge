...
/*-------------------*/
    ...
    function ninzio_thumbnail ($layout, $post_id){
        ...
        ?>
        <?php if ($layout == "standard" && !is_single()): ?>
        ...
        <?php if (has_post_thumbnail()): ?>
            ...
            <a class="nz-more media" href="<?php echo $href; ?>">
                <div class="nz-thumbnail">
                    ...
                    <div class="ninzio-overlay"><div class="ovhover"></div></div>
                </div>
            </a>
        <?php endif ?>
    ...
    function ninzio_port_thumbnail ($layout, $post_id){
        ...
        <?php if (has_post_thumbnail()): ?>
            <?php
                ...
                if (is_single() || ($layout == 'large' || $layout == 'medium' || $layout == 'small' || $layout == 'full')) {
                    $link_before     = '<a class="nz-more media" href="'.$href.'">';
                    $link_after      = "</a>";
                }
            ?>
            ...
            <div class="nz-thumbnail">
                <?php echo get_the_post_thumbnail( $post_id, $thumb_size );?>
                <div class="ninzio-overlay"><div class="ovhover">
                    <?php if (!is_single() && ($layout == 'image-grid-small' || $layout == 'image-grid-medium' || $layout == 'image-grid-large' || $layout == 'no-gap-grid-3' || $layout == 'no-gap-grid-4' || $layout == 'masonry-3' || $layout == 'masonry-4')): ?>
                       <div class="overlay-content">
                           <h3 class="project-title"><?php echo get_the_title() ?></h3>
                           <br>
                           <a class="button button-normal medium round animate-false hover-fill" href="<?php echo $href; ?>"><?php echo __('View project', TEMPNAME); ?></a>
                        </div> 
                    <?php endif ?>
                </div></div>
            </div>
