<?php
	...
	/*---------------------------------*/
		...
		$nz_desk_menu_border    = ($nz_ninzio['desk-menu-border'] && $nz_ninzio['desk-menu-border'] == 1) ? "true" : "false";
	...
	/*---------------------------------*/
		...
		$desk_class .= " menu-border-".$nz_desk_menu_border;
		...
		$mobarg = array( 
			...
			'link_after'     => '</span><span class="di icon-arrow-down7"></span>'
		);
		...
		$highlights_arg = array( 
			'theme_location' => 'highlights-menu', 
			'depth'          => 1, 
			'container'      => false, 
			'menu_id'        => 'highlights-menu'
		);
?>