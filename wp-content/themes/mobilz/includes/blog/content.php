...
<?php endif ?>
<div class="post-body">
	<?php if ($nz_blog_layout == "standard" && !is_single()): ?>
	...
	<?php if(is_single() || (!is_single() && $nz_blog_layout == "standard")) : ?>
		...
		<?php if (is_single()): ?>
			<?php if ($nz_rh == "false"): ?>
				...
				<?php endif; ?>
			<?php endif; ?>
		<?php elseif (!is_single() && $nz_blog_layout == "standard"): ?>
			<?php if ( '' != get_the_title() ): ?>
				<h2 class="post-title"><?php the_title(); ?></h2>
			<?php endif; ?>
		<?php endif ?>
			
		<?php if(is_single() || (!is_single() && $nz_blog_layout == "standard")){get_template_part('/includes/blog/content-blog-meta');} ?>
	...
	<?php else: ?>
		...
		<div class="post-excerpt">
			<?php echo nz_excerpt(150); ?>
		</div>

		<?php if ( '' == get_the_title() ): ?>
			<a href="<?php the_permalink(); ?>" class="read-more"><?php echo __("Read more", TEMPNAME); ?></a>
		<?php endif ?>
...
<?php if (is_single()): ?>
	<?php if ($nz_ninzio['blog-ss'] && $nz_ninzio['blog-ss'] == 1): ?>
		<div class="post-social-share social-links nz-clearfix left">
			<span class="share-message"><?php echo __('Share this post:', TEMPNAME); ?></span>
